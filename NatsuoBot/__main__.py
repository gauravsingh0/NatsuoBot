...
from NatsuoBot import (dispatcher, updater, TOKEN, OWNER_ID, WEBHOOK,
                           CERT_PATH, PORT, URL, LOGGER, BL_CHATS, WHITELIST_CHATS,
                           kp,oko )

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from NatsuoBot.modules import ALL_MODULES
from NatsuoBot.modules.helper_funcs.chat_status import is_user_admin
from NatsuoBot.modules.helper_funcs.misc import paginate_modules
from NatsuoBot.modules.helper_funcs.alternate import typing_action
...
BOT_IMG = "https://telegra.ph/file/ed1909261c2cd97c6169d.jpg"




HELP_STRINGS = """
*Helpful Commands :* [🙂](https://telegra.ph/file/ed1909261c2cd97c6169d.jpg)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("NatsuoBot.modules." + module_name)
...
#@run_async
#def NatsuoBot_about_callback(update, context):
...
def main():
    ...
    #about_callback_handler = CallbackQueryHandler(NatsuoBot_about_callback, pattern=r"home_back")
